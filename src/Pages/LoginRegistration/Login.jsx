          ...
          <div className="p-4 mt-6 mb-0 space-y-8 rounded-lg shadow-lg sm:p-6 lg:p-8">
            ...
            <div className="flex gap-6">
              <button
                ...
                className="flex items-center justify-center w-full max-w-xs px-4 py-2 mx-auto font-medium text-white bg-red-500 rounded-full shadow-sm hover:bg-red-400 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500"
              >
